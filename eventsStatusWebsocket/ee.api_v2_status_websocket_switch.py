...
if response.status_code == 200:
        ...
        account_id= response.json()["active_account_id"]
...
resp = requests.get('https://login.eagleeyenetworks.com/g/account/list?A=' + auth_key)
data= resp.json()
account_id = data[0][0]
account_nm = data[0][1]
account_id1= data[1][0]
account_nm1= data[1][1]
account_id2= data[2][0]
account_nm2= data[2][1]
print (account_id, account_nm, "Master account")
print (account_id1, account_nm1, "Sub account") 
print (account_id2, account_nm2, "Sub account")

accountid = input("please choose the correct accountid")

url = "https://" + branding + domain + "/g/aaa/switch_account?account_id=" + accountid
...
print("Switching account",response.status_code)
print(accountid)
...
resp = requests.get('https://login.eagleeyenetworks.com/g/device/list?A=' + auth_key)
data = resp.json()
devices = []
for v in data:
...
ws.connect('wss://login.eagleeyenetworks.com/api/v2/Device/' + accountid +'/Events?A=' + auth_key , verify=False, cookie='auth_key=' + auth_key)
